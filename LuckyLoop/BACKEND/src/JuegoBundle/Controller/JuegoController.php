...
class JuegoController extends AbstractController
{
                ...
                new OA\Property(
                    ...
                    items: new OA\Items(
                        properties: [
                            ...
                            new OA\Property(property: 'category', type: 'string', example: 'Juego de Azar'),
    ...
    //api doc categorias
    #[Route('/api/getCategorias', name: 'get-categorias', methods: ['GET'])]
    #[OA\Get(
        path: '/api/getCategorias',
        summary: 'Obtiene la lista de categorías disponibles',
        description: 'Devuelve todas las categorías únicas de los juegos',
        tags: ['Juego']
    )]
    #[OA\Response(
        response: 200,
        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(
                    property: 'categorias',
                    type: 'array',
                    items: new OA\Items(type: 'string', example: 'Juego de Mesa')
                )
            ]
        )
    )]
    ...
    {
        return $this->juegoService->getCategorias();
    }
}
